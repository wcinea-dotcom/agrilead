 ...
 "en": {
  ...
  "blog": {
    ...
    "posts": [
      ...
      ("blog-soil-health-starter.html","Applied Agronomy","Five Practical Habits for Healthier Farm Soil","July 1, 2026","4 min read","Five practical, low-cost approaches that beginning and small-scale producers can adopt to protect and improve soil health."),
    ],
  },
  ...
  "article": {
    ...
    "intro": "Healthy soil is the foundation of a resilient farm. It holds water, feeds crops, resists erosion, and recovers more quickly after a hard season. For beginning and small-scale producers, improving soil health rarely requires expensive equipment. It depends primarily on a few sound practices applied consistently over time.",
    ...
    "p_4": "A basic soil test takes the guesswork out of fertility. Knowing your soil&rsquo;s pH and nutrient levels helps you apply what the field actually needs while avoiding unnecessary expenses.",
  ...
  "article2": {
    ...
    "intro": "Since 2021, Haiti has faced a political, security, and institutional crisis of exceptional scale. The weakening of central institutions, widespread insecurity, and the interruption of many public services underscore a reality that has too often been overlooked: a State does not hold together through its central institutions alone, but also through its local territories. This reflection on decentralization and the communes is therefore intended not as an abstract academic exercise, but as a framework for rebuilding the Haitian State from the local level upward.",
    "paragraphs": [
      "The commune is far more than a mere administrative tier. It is the level of government at which access to public services, local planning, stakeholder coordination, and accountability to citizens take concrete form. At this level, closest to the population, the State either becomes tangible or gradually recedes.",
      ...
      "The 1987 Constitution had nonetheless opened another path. It established a clear territorial structure comprising the communal section, the commune, and the department, together with a resolutely decentralized vision of the State based on elected councils and local participation. Nearly four decades later, however, a persistent gap remains between the legal recognition of local governments and their practical effectiveness. Without clearly assigned responsibilities, capable local administrations, and adequate resources, communal autonomy remains largely theoretical.",
      ...
      "Territorial coordination and inter-communal cooperation are equally important. Many challenges, including water management, roads, waste, watersheds, and markets, extend beyond the boundaries of a single commune and require cooperation among neighboring jurisdictions. Better coordination among communes, communal sections, public institutions, NGOs, and international partners would reduce fragmented interventions and strengthen local impact.",
    ...
    "closing": "This text is intended as a contribution to the debate and an invitation to place the communes back at the heart of the national project. It does not claim to offer definitive answers, but seeks to open practical avenues for reflection. It is a personal contribution by Wilbert Georges, agronomist, development professional, and founder of AGRILEAD Training &amp; Consulting LLC, to the institutional, professional, and academic discussion on decentralization and local governance in Haiti. The analysis does not constitute legal advice.",
    "back": "&larr; Back to all articles",
  },
 },
 ...
 "fr": {
  ...
  "blog": {
    ...
    "posts": [
      ...
      ("blog-soil-health-starter.html","Agronomie appliquée","Cinq habitudes pratiques pour des sols agricoles plus sains","1 juillet 2026","4 min de lecture","Cinq pratiques simples et peu coûteuses que les producteurs débutants et les petits producteurs peuvent adopter pour protéger et améliorer la santé de leurs sols."),
    ],
  },
  ...
  "article": {
    ...
    "intro": "Un sol sain constitue le fondement d'une exploitation résiliente. Il retient l'eau, nourrit les cultures, résiste à l'érosion et se rétablit plus rapidement après une saison difficile. Pour les producteurs débutants et les petits producteurs, l'amélioration de la santé du sol nécessite rarement du matériel coûteux. Elle repose surtout sur quelques pratiques pertinentes, appliquées avec régularité dans la durée.",
    ...
    "p_4": "Une analyse de sol de base réduit les incertitudes liées à la fertilité. La connaissance du pH et des niveaux de nutriments permet d'apporter à la parcelle ce dont elle a réellement besoin, tout en évitant des dépenses inutiles.",
 ...
 "es": {
  ...
  "blog": {
    ...
    "posts": [
      ...
      ("blog-soil-health-starter.html","Agronomía aplicada","Cinco hábitos prácticos para un suelo agrícola más sano","1 de julio de 2026","4 min de lectura","Cinco prácticas sencillas y de bajo costo que los productores principiantes y pequeños pueden adoptar para proteger y mejorar la salud del suelo."),
    ],
  },
  ...
  "article": {
    ...
    "intro": "Un suelo sano constituye la base de una finca resiliente. Retiene el agua, alimenta los cultivos, resiste la erosión y se recupera con mayor rapidez después de una temporada difícil. Para los productores principiantes y pequeños, mejorar la salud del suelo rara vez requiere equipos costosos. Depende principalmente de algunas prácticas adecuadas, aplicadas de manera constante a lo largo del tiempo.",
    ...
    "p_4": "Un análisis básico del suelo reduce la incertidumbre sobre la fertilidad. Conocer el pH y los niveles de nutrientes permite aplicar únicamente lo que la parcela necesita y evitar gastos innecesarios.",
  ...
  "article2": {
    ...
    "paragraphs": [
      ...
      "La Constitución de 1987 había abierto, no obstante, otro camino. Consagró una arquitectura territorial clara, estructurada en torno a la sección comunal, la comuna y el departamento, así como una visión decididamente descentralizada del Estado, basada en consejos electos y en la participación local. Casi cuatro décadas después, persiste una brecha entre el reconocimiento jurídico de las colectividades y su efectividad real. Sin competencias claramente distribuidas, administraciones locales sólidas y recursos adecuados, la autonomía comunal sigue siendo en gran parte teórica.",
      ...
      "La coordinación territorial y la cooperación intercomunal también son condiciones esenciales. Numerosos desafíos, entre ellos la gestión del agua, las carreteras, los residuos, las cuencas hidrográficas y los mercados, rebasan las fronteras de una sola comuna y requieren la cooperación entre territorios vecinos. Una mejor coordinación entre las comunas, las secciones comunales, las instituciones públicas, las ONG y los socios internacionales ayudaría a reducir la dispersión de los esfuerzos y a reforzar el impacto local.",
    ...
    "closing": "Este texto constituye una contribución al debate y una invitación a situar nuevamente a las comunas en el centro del proyecto nacional. No pretende ofrecer respuestas definitivas, sino abrir vías de reflexión y acción. Se trata de una contribución personal de Wilbert Georges, agrónomo, profesional del desarrollo y fundador de AGRILEAD Training &amp; Consulting LLC, al debate institucional, profesional y académico sobre la descentralización y la gobernanza local en Haití. Este análisis no constituye asesoramiento jurídico.",
    "back": "&larr; Volver a todos los artículos",
  },
 },
}
...
<section class="hero hero--banner">
  <div class="hero-banner-media">
    <img src="/assets/img/home_hero_conclusiones.jpg" alt="{h["hero_alt"]}" loading="eager" decoding="async">
  </div>
